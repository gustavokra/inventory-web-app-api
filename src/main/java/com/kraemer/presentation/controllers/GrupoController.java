...
import com.kraemer.service.GrupoService;
...
public class GrupoController {
    ...
    public Response encontrarTodas(@HeaderParam EnumDBImpl dbImpl) {
        ...
        return Response.ok(service.encontrarTodos(dbImpl)).build();
    }

    @POST
    @Produces(MediaType.APPLICATION_JSON)
    @RolesAllowed({ "ADMIN", "USER" })
    public Response criar(GrupoDTO dto, @HeaderParam EnumDBImpl dbImpl) {
